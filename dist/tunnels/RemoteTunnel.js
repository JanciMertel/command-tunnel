...
const BundledTcpServer_1 = require("../BundledTcpServer");
class RemoteTunnel extends AbstractTunnel_1.default {
    constructor(tunnelConfig) {
        ...
        if (this.isServer) {
            if (tunnelConfig.tcpServer) {
                ...
                this.tcpServer = BundledTcpServer_1.default;
